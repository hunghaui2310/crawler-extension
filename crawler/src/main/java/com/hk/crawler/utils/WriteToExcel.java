...
public class WriteToExcel {
    ...
    public static void writeExcel(List<Shop> books, String excelFilePath) throws IOException {
        // Create Workbook
    ...
    // Create dummy data
    private static List<Shop> getBooks() {
        List<Shop> listBook = new ArrayList<>();
        Shop book;
        for (int i = 1; i <= 5; i++) {
            book = new Shop("Book " + i, "" + (i * 2), "" + (i * 1000));
            listBook.add(book);
        }
        return listBook;
    }
    ...
    // Write data
    private static void writeBook(Shop book, Row row) {
